 ...
 *
 * @phpstan-type LoyaltyClassType array{id: string, issuerName: string, reviewStatus: ReviewStatus, programName?: string, localizedProgramName?: LocalizedStringType, programLogo?: ImageType, wideProgramLogo?: ImageType, hexBackgroundColor?: string, localizedIssuerName?: LocalizedStringType, countryCode?: string, heroImage?: ImageType, enableSmartTap?: bool, redemptionIssuers?: list<string>, multipleDevicesAndHoldersAllowedStatus?: MultipleDevicesAndHoldersAllowedStatus, callbackOptions?: CallbackOptionsType, securityAnimation?: SecurityAnimationType, viewUnlockRequirement?: ViewUnlockRequirement, messages?: list<GoogleMessageType>, imageModulesData?: list<ImageModuleDataType>, textModulesData?: list<TextModuleDataType>, linksModuleData?: LinksModuleDataType, homepageUri?: UriType, appLinkData?: AppLinkDataType, merchantLocations?: list<MerchantLocationType>, valueAddedModuleData?: list<ValueAddedModuleDataType>, notifyPreference?: NotifyPreference, review?: ReviewType}
 */
class LoyaltyClass
{
    /**
