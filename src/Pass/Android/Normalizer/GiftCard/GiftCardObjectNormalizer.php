 ...
 */
class GiftCardObjectNormalizer implements NormalizerInterface, NormalizerAwareInterface
{
    use NormalizerAwareTrait;

    /**
     * @param GiftCardObject       $object
     * @param array<string, mixed> $context
     *
     * @return GiftCardObjectType
     */
    public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (null !== $object->balanceUpdateTime) {
            $data['balanceUpdateTime'] = $this->normalizer->normalize($object->balanceUpdateTime, $format, $context);
        }

        if (null !== $object->eventNumber) {
            $data['eventNumber'] = $object->eventNumber;
        }
    ...
    {
        return $data instanceof GiftCardObject;
    }

    /** @return array<class-string, bool> */
    public function getSupportedTypes(?string $format): array
    {
        return [GiftCardObject::class => true];
    }
}
